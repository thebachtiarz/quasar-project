...
const RestServices = {
  ...
  // ! admin maintenance
  getResAdminMenuIndex: (request = 'countOnly') => axios.get(`/api/admin/menu?_users=${request}&_newMembers=${request}&_unlistedUsers=${request}&_lostPassword=${request}`, CredMng.axiosHeaderToken()).catch(err => axiosResErrorNotify(err, 'error')),
